    ...
    public class u_applicationController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id_app,nom_app,nombre_telechargement,date_ajout,categorie,id_user,app_img,u_description,img")] u_application u_application )
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                u_application.utilisateur = Session["user"] as utilisateur;
                if (u_application.utilisateur.u_role != "admin")
                    u_application.utilisateur.u_role = "prop";
        ...
        public ActionResult telechagerApp(int id)
        {
            try
            {
                ...
                utilisateur user = Session["user"] as utilisateur;
                bibliotheque bib = null; 
                if (user.bibliotheque == null)
                    user.bibliotheque = new bibliotheque();
                else 
                    bib = user.bibliotheque;
                ...
                bib.Bibliotheque_app.Add(appbib);
                db.SaveChanges();
                return RedirectToAction("index", "u_application");
            }
        ...
        public ActionResult ajouterBib(int id)
        {
            Bibliotheque_app bib = new Bibliotheque_app();
